package com.company.jmixtestwd.test_support;

import com.company.jmixtestwd.JmixtestwdApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "jmxwd_MainScreen", screenBasePackages = "com.company.jmixtestwd.screen")
@ContextConfiguration(classes = {JmixtestwdApplication.class, UiTestAssistConfiguration.class})
